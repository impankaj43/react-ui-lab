...
| 12  | **File EXplorer**                        | Build a File Explorer / Nested Tree component in React that renders a nested tree structure from JSON data. User can expand/collapse folders and select files. |
