# ⚛️ React UI Lab — Master React UI, one feature at a time.

Welcome to the **React UI Lab**!  
This repository is a curated collection of hands-on React UI implementations and machine coding challenges. Each folder contains a standalone mini-app focused on a specific UI feature or problem — built with React and modern JavaScript practices.
...
| 12  | **File EXplorer**                        | Build a **File Explorer / Nested Tree** component in React that renders a nested tree structure from JSON data. User can expand/collapse folders, select files, and add/delete nodes via context menu. |
